...
public class HerniPlan {    
    ...
    */
    private void zalozProstoryHry() {
        ...
        Prostor roklinka = new Prostor("Roklinka","Roklince, elfském útočišti");
        Prostor rozcesti = new Prostor("Rozcesti","rozcestí, teď si musíš vybrat, kudy dál");
        Prostor prusmyk = new Prostor("Prusmyk", "nebezečném horském průsmyku, kterým lze přejít hory");
        Prostor morie = new Prostor("Morie","Morii, starých trpaslíčích síních pod horami");
        Prostor zelezny_pas = new Prostor("Zelezny_pas","Železném pasu, sídle zlého čaroděje Sarumana");
        Prostor lorien = new Prostor("Lorien","Lórienu, lese obývaném elfským národem");
        Prostor reka = new Prostor("Reka","Velké řece, dopluješ po ní dále na východ do Amon Henu");
        Prostor rohan = new Prostor("Rohan","Rohanu, zemi pánů koní ohrožované zlým čarodějem Sarumanem");
        Prostor amon_hen = new Prostor("Amon_Hen","Amon Henu, západní části pahorkatiny Emyn Muil");
        Prostor emyn_muil = new Prostor("Emyn_Muil","Emyn Muilu, skalnatém bludiště nedaleko Mordoru, číhá v něm Glum");
        Prostor cerna_brana = new Prostor("Cerna_brana","Černé bráně, hlavním vchodu do Mordoru, je pečlivě hlídaný skřety");
        Prostor hora_osudu = new Prostor("Hora_osudu","Hoře osudu, cíli výpravy, hoď prsten do lávy!");
        Prostor ithilien = new Prostor("Ithilien","Ithilienu, vybydlené zemi mezi Gondorem a Mordorem");
        Prostor minas_morgul = new Prostor("Minas_Morgul","Minas Morgul, černokněžném městě, v jehož blízkosti se nachází tajná cesta do Mordoru");
